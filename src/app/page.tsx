              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-700 dark:text-gray-300 font-medium">{t('contact.address.location')}</p>
                      <p className="text-gray-600 dark:text-gray-400">{t('contact.address.location.desc')}</p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-700 dark:text-gray-300 font-medium">{t('contact.additional.zip')}</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-700 dark:text-gray-300 font-medium">{t('contact.additional.website')}</p>
